package net.CSmohmmadSH.tutorialmod.worldgen;
...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> overworldBlackRubyOres = List.of(OreConfiguration.target(stoneReplaceables,
        ...
        register(context, OVERWORLD_RUBY_ORE_KEY, Feature.ORE, new OreConfiguration(overworldBlackRubyOres, 9));
        register(context, END_RUBY_ORE_KEY, Feature.ORE, new OreConfiguration(endstoneReplaceables,
                ModBlocks.ENDSTONE_RUBY_ORE.get().defaultBlockState(), 9));
        register(context, NETHER_RUBY_ORE_KEY, Feature.ORE, new OreConfiguration(netherrackReplaceables,
                ModBlocks.NETHERRACK_RUBY_ORE.get().defaultBlockState(), 9));
